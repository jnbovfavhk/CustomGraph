...
// 2 компоненты связности: 1 дерево и нет дерева

// пример ребра отрицеательного веса в котором дейкстар ошибается

// правда ли что дейкстра это расширение алгоритма в ширину - да. В обходе в ширину мы идем от вершины,
// добавляя ее в очередь и присваиваем всем ее соседям расстояние (расстояние до вершины + 1), при этом
// запоминаем вершину из которой пришли, а в Дейкстре мы добавляем вершину в очередь, для всех ее соседей ставим
// расстояние (расстояние до вершины + вес до соседа), при этом обновляем только если новое расстояние меньше старого
// и запоминаем вершину из которой пришли
